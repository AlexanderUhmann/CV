...
{\small Alexander Uhmann \icon{\faEnvelopeO}{cvgreen}{} Deutschland \icon{\faMapMarker}{cvgreen}{} Leipzig \icon{\faPhone}{cvgreen}{} 0172/1854194 \newline\icon{\faAt}{cvgreen}{} \protect\url{alexander.uhmann@gmail.com}
}
\end{center}
\end{minipage}
